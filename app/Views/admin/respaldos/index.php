...
<div class="cards-container">
    ...
    <div class="module-card" style="grid-column: 1 / -1; border-color: #ef4444; background: #fff1f2;">
        ...
        <form method="POST" action="<?= APP_BASE ?>/admin/respaldos/action" id="form-backup-zip">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                fetch('<?= APP_BASE ?>/api/admin/backup_size')
                    .then(res => res.json())
                    .then(data => {
    ...
    <div class="module-card">
        ...
        <form method="POST" action="<?= APP_BASE ?>/admin/respaldos/action">
    ...
    <div class="module-card">
        ...
        <form method="POST" action="<?= APP_BASE ?>/admin/respaldos/action" enctype="multipart/form-data">
