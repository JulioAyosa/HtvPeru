...
<div class="dashboard-container">
    <div class="header-rep">
        ...
        <img src="<?= APP_BASE ?>/img/logo.webp" alt="HTVPERU Logo" style="filter: grayscale(100%); opacity: 0.8;">
    </div>

    <div class="filters no-print">
        <form method="GET" action="<?= APP_BASE ?>/admin/reportes" style="display: contents;">
            ...
            <a href="<?= APP_BASE ?>/admin/reportes" class="btn-rep out" title="Limpiar"><i class="ri-refresh-line"></i></a>
        </form>
        ...
        <div style="flex-grow: 1; text-align: right; display: flex; gap: 0.5rem; justify-content: flex-end;">
            ...
            <a href="<?= APP_BASE ?>/admin" class="btn-rep out" style="margin-left:1rem;"><i class="ri-arrow-go-back-line"></i> Al Panel</a>
        </div>
    </div>
