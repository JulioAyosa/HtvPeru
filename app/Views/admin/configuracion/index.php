                        ...
                        <div class="module-card">
                            ...
                            <div class="module-body" style="background: white; display: flex; flex-direction: column; gap: 0.75rem;">
                                <div class="img-preview" style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 1rem; text-align: center;">
                                    <img src="<?php echo base_url($configs['logo_url'] ?? 'img/logo.webp'); ?>" alt="Logo" style="max-height: 50px;">
                                </div>
                        ...
                        <div class="module-card">
                            ...
                            <div class="module-body" style="background: white; display: flex; flex-direction: column; gap: 0.75rem;">
                                <div class="img-preview" style="background: white; border: 1px solid #e2e8f0; border-radius: 8px; padding: 1rem; text-align: center;">
                                    <img src="<?php echo base_url($configs['favicon_url'] ?? 'img/logo.webp'); ?>" alt="Favicon" style="height:32px;">
                                </div>
                        ...
                        <div class="module-card">
                            ...
                            <div class="module-body" style="background: white; display: flex; flex-direction: column; gap: 0.75rem;">
                                <div class="img-preview" style="background: var(--bg-main); border: 1px solid #e2e8f0; border-radius: 8px; padding: 1rem; text-align: center;">
                                    ...
                                    <img src="<?php echo base_url($configs['watermark_url']); ?>" alt="Watermark" style="max-height: 40px;">
                                    <?php else: ?>
                        ...
                        <div class="module-card">
                            ...
                            <div class="module-body" style="background: white; display: flex; flex-direction: column; gap: 0.75rem;">
                                <div class="img-preview" style="background: var(--bg-main); border: 1px solid #e2e8f0; border-radius: 8px; padding: 1rem; text-align: center;">
                                    ...
                                    <img src="<?php echo base_url($configs['header_bg_url']); ?>" alt="Header BG" style="max-height: 40px; border-radius: 4px;">
                                    <?php else: ?>
                        ...
                        <div class="module-card">
                            ...
                            <div class="module-body" style="background: white; display: flex; flex-direction: column; gap: 0.75rem;">
                                <div class="img-preview" style="background: var(--bg-main); border: 1px solid #e2e8f0; border-radius: 8px; padding: 1rem; text-align: center;">
                                    ...
                                    <img src="<?php echo base_url($configs['seo_og_image']); ?>" alt="og:image" style="max-height: 80px;">
                                    <?php else: ?>
                            ...
                            <div class="module-body" style="background: white; display: flex; flex-direction: column; gap: 0.75rem;">
                                <div class="pdf-upload-zone" style="margin-bottom: 0;">
                                    <?php if(!empty($configs['privacy_policy_url'])): ?>
                                        ...
                                        <a href="<?php echo base_url($configs['privacy_policy_url']); ?>" target="_blank" style="font-size:0.85rem; font-weight:700; color:var(--primary-color); display:inline-flex; align-items:center; gap:0.3rem; text-decoration:none;">
