...
<body>
    ...
    <main class="container" style="min-height: 50vh; display: grid; grid-template-columns: 1fr 320px; gap: 2.5rem; align-items: start; margin-top: 2rem;">
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="<?= APP_BASE ?>/buscar?q=<?php echo urlencode($q); ?>&page=<?php echo $page - 1; ?>" class="page-link"><i class="ri-arrow-left-s-line"></i></a>
            <?php endif; ?>
            
            <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                <a href="<?= APP_BASE ?>/buscar?q=<?php echo urlencode($q); ?>&page=<?php echo $i; ?>" class="page-link <?php echo $i === $page ? 'active' : ''; ?>"><?php echo $i; ?></a>
            <?php endfor; ?>

            <?php if ($page < $total_pages): ?>
                <a href="<?= APP_BASE ?>/buscar?q=<?php echo urlencode($q); ?>&page=<?php echo $page + 1; ?>" class="page-link"><i class="ri-arrow-right-s-line"></i></a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        </div>
