...
<head>
    ...
    <title>Resultados para "<?php echo htmlspecialchars($q); ?>" - HTVPERU</title>
...
<body>
    ...
    <div class="category-header">
        <div class="container">
            <h1 class="category-title">Resultados de búsqueda: "<?php echo htmlspecialchars($q); ?>"</h1>
            <p class="category-subtitle">Se encontraron <?php echo $total_rows; ?> noticias relacionadas.</p>
        </div>
    </div>
    ...
    <main class="container" style="min-height: 50vh; display: grid; grid-template-columns: 1fr 320px; gap: 2.5rem; align-items: start; margin-top: 2rem;">
        ...
        <div class="content-col" style="min-width:0;">
            ...
            <?php else: ?>
                <div style="grid-column: 1 / -1; text-align:center; padding: 4rem; color:var(--text-muted);">
                    <i class="ri-search-line" style="font-size:4rem; margin-bottom:1rem; display:block; color:#cbd5e1;"></i>
                    No pudimos encontrar noticias que coincidan con "<?php echo htmlspecialchars($q); ?>". Intenta con otras palabras clave.
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="?q=<?php echo urlencode($q); ?>&page=<?php echo $page - 1; ?>" class="page-link"><i class="ri-arrow-left-s-line"></i></a>
            <?php endif; ?>
            
            <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                <a href="?q=<?php echo urlencode($q); ?>&page=<?php echo $i; ?>" class="page-link <?php echo $i === $page ? 'active' : ''; ?>"><?php echo $i; ?></a>
            <?php endfor; ?>

            <?php if ($page < $total_pages): ?>
                <a href="?q=<?php echo urlencode($q); ?>&page=<?php echo $page + 1; ?>" class="page-link"><i class="ri-arrow-right-s-line"></i></a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
        </div>
