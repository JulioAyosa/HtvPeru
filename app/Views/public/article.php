...
<body>
    ...
    <main class="container main-grid" style="padding: 2rem 1.5rem; display: grid; grid-template-columns: 1fr 340px; gap: 3.5rem; align-items: start;">
        ...
        <div class="article-tags">
            ...
            ?>
                <a href="<?= APP_BASE ?>/etiqueta/<?php echo urlencode($tag_slug); ?>" class="tag" style="text-decoration:none; display:inline-block; transition:transform 0.2s;"><?php echo htmlspecialchars($tag); ?></a>
            <?php endforeach; ?>
        </div>
        <?php endif; ?>
        ...
        <section class="related-articles">
            ...
            <div class="related-grid">
                ...
                <div class="related-card">
                    <a href="<?= APP_BASE ?>/<?php echo urlencode($rel_articulo['slug']); ?>">
                        <?php echo renderMedia($rel_articulo['imagen_url'], '', $rel_articulo['video_poster_url'] ?? ''); ?>
                    </a>
                    <div class="related-card-content">
                        <span class="related-card-category"><a href="<?= APP_BASE ?>/categoria/<?php echo urlencode(strtolower($rel_articulo['categoria'])); ?>" style="color:var(--primary-color); text-decoration:none;"><?php echo htmlspecialchars($rel_articulo['categoria']); ?></a></span>
                        <h3 class="related-card-title"><a href="<?= APP_BASE ?>/<?php echo urlencode($rel_articulo['slug']); ?>"><?php echo htmlspecialchars($rel_articulo['titulo']); ?></a></h3>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <aside class="sidebar-col">
            <div style="background:var(--bg-card); border:1px solid var(--border-color); border-radius:var(--radius-lg); padding:1.5rem; position:sticky; top:2rem;">
                ...
                <div style="display:flex; flex-direction:column; gap:1.25rem; margin-top:1.5rem;">
                    ...
                    <a href="<?= APP_BASE ?>/<?php echo urlencode($sn['slug']); ?>" style="display:flex; gap:1rem; text-decoration:none;">
    ...
    <div id="gdpr-cookie-banner" style="position:fixed; bottom:0; left:0; width:100%; background:#111827; color:white; padding:1rem; z-index:99999; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; box-shadow:0 -5px 20px rgba(0,0,0,0.5);">
        <div style="flex:1; min-width:300px; font-size:0.85rem; margin-right:2rem; font-family:var(--font-sans);">
            Utilizamos cookies propias y de terceros para fines analíticos y para mostrarte publicidad personalizada en base a un perfil elaborado a partir de tus hábitos de navegación. <a href="<?= APP_BASE ?>/pagina/politica-y-privacidad" style="color:#60a5fa; text-decoration:underline;">Ver política</a>.
        </div>
