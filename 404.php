...
<body>
    ...
    <main class="container error-container">
        ...
        <form action="/piura_noticias_php/buscar" method="GET" style="width: 100%; max-width: 500px; margin: 0 auto 2rem auto; display: flex; border-radius: 50px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
        ...
        <div style="margin-bottom: 2rem;">
            ...
            <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="/piura_noticias_php/categoria/actualidad" style="color: <?php echo htmlspecialchars($site_color); ?>; text-decoration: none; font-weight: 600;">Actualidad</a>
                <span style="color: #cbd5e1;">|</span>
                <a href="/piura_noticias_php/categoria/politica" style="color: <?php echo htmlspecialchars($site_color); ?>; text-decoration: none; font-weight: 600;">Política</a>
                <span style="color: #cbd5e1;">|</span>
                <a href="/piura_noticias_php/categoria/deportes" style="color: <?php echo htmlspecialchars($site_color); ?>; text-decoration: none; font-weight: 600;">Deportes</a>
                <span style="color: #cbd5e1;">|</span>
                <a href="/piura_noticias_php/categoria/entretenimiento" style="color: <?php echo htmlspecialchars($site_color); ?>; text-decoration: none; font-weight: 600;">Entretenimiento</a>
            </div>
        </div>

        <a href="/piura_noticias_php/" class="btn-home"><i class="ri-home-4-line"></i> Volver a la Portada</a>
    </main>
